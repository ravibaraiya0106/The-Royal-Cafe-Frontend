  ...
  return (
    <DeliveryLayout>
      <div className="space-y-6 max-w-3xl mx-auto">
        {/* Header Brief */}
        <div className="bg-white p-5 rounded-[5px] border border-gray-200 shadow-sm flex items-center gap-4">
          <div className="w-14 h-14 rounded-[5px] bg-brand text-white font-bold text-2xl flex items-center justify-center shadow-md">
        ...
        {/* Info Cards */}
        <div className="bg-white border border-gray-200 rounded-[5px] p-6 shadow-sm space-y-6">
          <h2 className="text-sm font-semibold uppercase tracking-wider text-brand border-b border-gray-100 pb-3 font-serif">
            Agent Information
          </h2>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div className="bg-white p-4 rounded-[5px] border border-gray-200 space-y-1">
        ...
        <div className="bg-white border border-gray-200 rounded-[5px] p-6 shadow-sm space-y-4">
          <h2 className="text-sm font-semibold uppercase tracking-wider text-brand border-b border-gray-100 pb-3 flex items-center gap-2 font-serif">
            <FiTruck className="w-4 h-4" />
            <span>Vehicle Details</span>
          </h2>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div className="bg-white p-4 rounded-[5px] border border-gray-200">
        ...
        <div className="pt-2">
          <button
            ...
            className="w-full py-3 bg-red-50 hover:bg-red-100 border border-red-200 text-red-700 font-bold rounded-[5px] transition-all flex items-center justify-center gap-2 text-sm shadow-sm"
          >
